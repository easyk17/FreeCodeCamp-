...
def main():
    ...
    # Fixes Story 2 & 3 (Gracefully manages comma errors without crashing)
    if len(values) != 2:    
...
# You don't have to know the detailed calculation logic in this lab. 
# The functions calculate_check_digit_10 and calculate_check_digit_13 will take care of the calculation and return the expected check digit in string.
...
# Does not match specified length or left blank	Valid	ISBN-10 code should be 10 digits long. or ISBN-13 code should be 13 digits long., 
# depending on the length they entered.	9781530051120,10 or 1530051126,13
